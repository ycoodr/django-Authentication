...
#help_text='<strong>Enter your first name here</strong>' ,
    class Meta:
        model = User
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['username'].help_text = '<div class="form-text text-muted"> <small>Required. 150 characters or fewer. Letters, digits and @/./+/-/_ only.</small>'
